...
This repository contains different functions to retrieve the DOI of a reference
...
> Casajus N. & Bellouin D. (2022) agrite: A toolbox to retrieve DOI of a reference citation.
